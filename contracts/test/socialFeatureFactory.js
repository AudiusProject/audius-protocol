...
contract('SocialFeatureFactory', async (accounts) => {
  ...
  beforeEach(async () => {
    ...
    await registry.addContract(
      _constants.socialFeatureStorageKey,
      socialFeatureStorage.address
    )
    socialFeatureFactory = await SocialFeatureFactory.new(
      registry.address,
      _constants.socialFeatureStorageKey,
      _constants.userFactoryKey,
      _constants.trackFactoryKey,
    ...
    await registry.addContract(
      _constants.socialFeatureFactoryKey,
  ...
  it('Should add one TrackRepost', async () => {
    ...
    await _lib.addTrackRepostAndValidate(
      socialFeatureFactory,
      accounts[0],
      testUserId1,
      testTrackId1
  ...
  it('Should add and delete one TrackRepost', async () => {
    ...
    await _lib.deleteTrackRepostAndValidate(
      socialFeatureFactory,
      accounts[0],
      testUserId1,
      testTrackId1
  ...
  it('Should add one PlaylistRepost', async () => {
    await _lib.addPlaylistRepostAndValidate(
      socialFeatureFactory,
      accounts[0],
      testUserId1,
      playlistId1
  ...
  it('Should add and delete one PlaylistRepost', async () => {
    ...
    await _lib.deletePlaylistRepostAndValidate(
      socialFeatureFactory,
      accounts[0],
      testUserId1,
      playlistId1
  ...
  it('Should add one UserFollow', async () => {
    ...
    await _lib.addUserFollowAndValidate(
      socialFeatureFactory,
      accounts[0],
      testUserId1,
      testUserId2
  ...
  it('Should add and delete one UserFollow', async () => {
    ...
    await _lib.deleteUserFollowAndValidate(
      socialFeatureFactory,
      accounts[0],
      testUserId1,
      testUserId2
