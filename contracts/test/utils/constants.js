...
export const discoveryProviderStorageKey = web3New.utils.utf8ToHex(
  'DiscoveryProviderStorage'
)
export const discoveryProviderFactoryKey = web3New.utils.utf8ToHex(
...
export const socialFeatureFactoryKey = web3New.utils.utf8ToHex(
  'SocialFeatureFactory'
)
export const socialFeatureStorageKey = web3New.utils.utf8ToHex(
  'SocialFeatureStorage'
)
export const ipldBlacklistFactorykey = web3New.utils.utf8ToHex(
  'IPLDBlacklistFactory'
)
export const userLibraryFactoryKey =
  web3New.utils.utf8ToHex('UserLibraryFactory')
export const userReplicaSetManagerKey = web3New.utils.utf8ToHex(
...
export const userMetadata = {
  name: web3New.utils.padRight(
    web3New.utils.utf8ToHex('Firstname Lastname'),
    64
  ),
  location: web3New.utils.padRight(
    web3New.utils.utf8ToHex('San Francisco'),
    64
  ),
