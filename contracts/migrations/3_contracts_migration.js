...
const discoveryProviderStorageKey = web3.utils.utf8ToHex(
  'DiscoveryProviderStorage'
)
const discoveryProviderFactoryKey = web3.utils.utf8ToHex(
...
module.exports = (deployer, network, accounts) => {
  deployer.then(async () => {
    ...
    await registry.addContract(
      ipldBlacklistFactorykey,
      IPLDBlacklistFactory.address
    )
  })
}
