...
describe('test cognitoHelpers', () => {
  ...
  it('cognito signature returns the correctly signed data', () => {
    ...
    assert.strictEqual(
      signature,
      'yw0hqBPOIWcHPFZBsaMPnxktOrWwWkZcWP+TneV5D48='
    )
  })
  ...
  it('webhook validation returns true when webhook is valid', () => {
    ...
    const headers = {
      ...
      authorization:
        'Signature keyId="live_key_deadbeefcafedeadbeefcafedeadbeef",algorithm="hmac-sha256",headers="(request-target) date digest",signature="PkvXq6CcH0d5HA7hiK5JWsA+e7G+7fuZPLtM2rMe4/8="'
    }
