...
const { createStarterUser, testEthereumConstants } = require('./lib/dataSeeds')
...
describe('test Users', function () {
  ...
  it('logout works', async function () {
    const session = await createStarterUser()
    await request(app)
      .post('/users/logout')
  ...
  it('logout all other sessions works', async function () {
    const session = await createStarterUser()
    await request(app)
