...
--
-- Name: audius_discovery; Type: DATABASE; Schema: -; Owner: -
--

CREATE DATABASE audius_discovery WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.utf8' LC_CTYPE = 'en_US.utf8';
...
--
-- Name: tracks tracks_blockhash_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tracks
    ADD CONSTRAINT tracks_blockhash_fkey FOREIGN KEY (blockhash) REFERENCES public.blocks(blockhash);
...
--
-- Name: users users_blockhash_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.users
    ADD CONSTRAINT users_blockhash_fkey FOREIGN KEY (blockhash) REFERENCES public.blocks(blockhash);
