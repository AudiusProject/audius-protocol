...
docker run --platform linux/amd64 --name audius_ganache_cli_eth_contracts_test -d -p 8556:8545 trufflesuite/ganache-cli:latest -h 0.0.0.0 -l 8000000 -a 500 -k istanbul
...
elif [ $1 == '--audius-random' ] && [ $# -eq 1 ]; then
