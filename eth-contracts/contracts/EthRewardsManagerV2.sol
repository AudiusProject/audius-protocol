...
contract EthRewardsManagerV2 is InitializableV2 {
  ...
  function initialize(
    ...
    require(Address.isContract(_wormholeAddress), ERROR_WORMHOLE_NOT_CONTRACT);
   ...
   */
  function setAntiAbuseOracleAddresses(
    address[] calldata _antiAbuseOracleAddresses
  ) external {
    _requireIsInitialized();
