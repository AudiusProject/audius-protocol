...
func TestGossip(t *testing.T) {
	...
	r3.InsertOtherHostsView(s2.URL, 100)
	...
	r4.InsertOtherHostsView(s3.URL, 100)
	...
	r2.InsertOtherHostsView(s1.URL, 100)
	...
	r3.InsertOtherHostsView(s4.URL, 100)
	...
	r4.InsertOtherHostsView(s1.URL, 100)
	assertHostsWithCID(r4, cidV0Img, []string{s1.URL, s2.URL, s3.URL, s4.URL})
	r3.InsertOtherHostsView(s4.URL, 100)
	...
	r4.InsertOtherHostsView(s3.URL, 100)
	r5.InsertOtherHostsView(s4.URL, 100)
	...
	r5.InsertOtherHostsView(s3.URL, 100)
	r5.InsertOtherHostsView(s2.URL, 100)
	r5.InsertOtherHostsView(s1.URL, 100)
	assertHostsWithCID(r5, cidV0Img, []string{s2.URL, s3.URL, s4.URL})
	assertHostsWithCID(r5, cidV0Track, []string{s1.URL})
	assertHostsWithCID(r5, cidV1, []string{s2.URL, s3.URL})
}
