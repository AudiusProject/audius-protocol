...
require (
	...
	github.com/AudiusProject/audius-protocol/mediorum v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/cometbft/cometbft v1.0.0-rc1.0.20240821165313-db37bd322ea5 // indirect
