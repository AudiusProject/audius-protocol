...
import * as searchPageActions from 'pages/search-page/store/actions'
import { tracksActions as tracksLineupActions } from 'pages/search-page/store/lineups/tracks/actions'
