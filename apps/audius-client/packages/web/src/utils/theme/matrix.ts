const theme = {
  ...
  '--notification-unread-border-hover': 'var(--neutral-light-6)',
  ...
  '--page-header-gradient-2-alt': 'var(--neutral-light-10)',
  '--page-header-text-shadow':
    '0px 0px 5px rgba(225, 255, 234, 0.25), 0px 0px 15px rgba(20, 255, 0, 0.25)',
