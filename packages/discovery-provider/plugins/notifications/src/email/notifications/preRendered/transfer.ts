export const email = ({
  ...
  * {
  ...
  <tr>
  <td>
  <div style="line-height:20px;text-align:left;"><a target="_blank" href="https://solscan.io/tx/${signature}"><span style="color:#cc0fe0;font-family:Inter,Arial,sans-serif;font-size:15px;line-height:20px;text-align:left;text-decoration:underline;">View on Solana </span><span style="color:#cc0fe0;font-family:Inter,Arial,sans-serif;font-size:15px;line-height:20px;text-align:left;text-decoration:underline;">Explorer</span></a></div>
  </td>
  </tr>
  </table>
  </td>
