...
-- delete listen streak challenges in the range contained in the csv
delete from user_challenges where challenge_id = 'e' and created_at <= '2025-03-25' and created_at > '2025-03-14';

-- also delete tastemaker challenges
delete from user_challenges where challenge_id = 't';
...
FROM temp_listen_streak_tastemaker_challenges
