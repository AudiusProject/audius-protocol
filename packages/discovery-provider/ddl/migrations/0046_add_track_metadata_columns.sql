...
-- inherit download conditions from premium conditions for stream gated downloadable tracks
update tracks set is_download_gated = true
  where is_current is true and is_premium is true and (download->>'is_downloadable')::boolean is true;
update tracks set download_conditions = premium_conditions
  where is_current is true and is_premium is true and (download->>'is_downloadable')::boolean is true;
...
from (
  ...
  and (download->>'is_downloadable')::boolean is true
