...
UPDATE challenges SET id = 'p' WHERE challenge_id = 'profile-completion';
UPDATE challenges SET id = 'l' WHERE challenge_id = 'listen-streak';
UPDATE challenges SET id = 'u' WHERE challenge_id = 'track-upload';
UPDATE challenges SET id = 'r' WHERE challenge_id = 'referrals';
UPDATE challenges SET id = 'rv' WHERE challenge_id = 'ref-v';
UPDATE challenges SET id = 'rd' WHERE challenge_id = 'referred';
UPDATE challenges SET id = 'v' WHERE challenge_id = 'connect-verified';
UPDATE challenges SET id = 'm' WHERE challenge_id = 'mobile-install';
UPDATE challenges SET id = 'ft' WHERE challenge_id = 'send-first-tip';
UPDATE challenges SET id = 'fp' WHERE challenge_id = 'first-playlist';
