...
def test_access_conditions(app, mocker, tx_receipts):
    ...
    test_metadata = {
        ...
        "UpdatePlaylistAccessConditionsMakePublic": {
            "playlist_contents": {"track_ids": [{"time": 1660927554, "track": 1}]},
            "description": "",
            "playlist_image_sizes_multihash": "",
            "playlist_name": "album",
        ...
        "InvalidUpdatePlaylistAccessConditions": {
            "playlist_contents": {"track_ids": []},
            "description": "",
            "playlist_image_sizes_multihash": "",
    ...
    update_album_access_conditions_make_public_json = json.dumps(
        test_metadata["UpdatePlaylistAccessConditionsMakePublic"]
    )
                ...
                "args": AttributeDict(
                    {
                        ...
                        "_userId": 1,
                        "_action": "Update",
                        "_metadata": f'{{"cid": "UpdateAlbumAccessConditionsMakePublic", "data": {update_album_access_conditions_make_public_json}}}',
                        "_signer": "user1wallet",
                    }
                )
            },
    ...
    with db.scoped_session() as session:
        ...
        all_playlists: Playlist = session.query(Playlist).all()
        ...
        # Validate previously usdc-gated album that was made public
        album: Playlist = (
            session.query(Playlist)
