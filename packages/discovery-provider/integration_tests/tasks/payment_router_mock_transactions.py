...
# Routes $1.00 to a single recipient w/ memo for track purchase and memo for location data
mock_valid_track_purchase_single_recipient_tx_with_location = GetTransactionResp.from_json(
    json.dumps(
        {
            "jsonrpc": "2.0",
            "result": {
...
# Valid purchase transaction specifying stream access purchase in memo
mock_valid_track_purchase_stream_access = GetTransactionResp.from_json(
    json.dumps(
        {
            "jsonrpc": "2.0",
...
# Valid purchase transaction specifying download access purchase in memo
    ...
    json.dumps(
        {
            ...
            "result": {
                ...
                "transaction": {
                    "signatures": [
                        "5wPxiuLSF3MzXZt9XG99UEPNdxs8DtE2vWKezrB6zuMCrkMBJx6iU7xw5icaowpfgj96iLGnAgEAaBNSbneWdbZY"
                    ],
                    "message": {
                        "header": {
                            "numRequiredSignatures": 1,
