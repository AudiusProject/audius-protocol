...
# Purchase of track id 1 for $1 USDC using a non-userbank USDC ATA
# and passing purchaserId through the memo
mock_valid_track_purchase_non_userbank_source_tx = GetTransactionResp.from_json(
    json.dumps(
        {
            "jsonrpc": "2.0",
            "result": {
                    ...
                    "message": {
                        ...
                        "instructions": [
                            ...
                            },
                            {
                                "programIdIndex": 8,
                                "accounts": [0],
                                "data": PURCHASE_TRACK1_MEMO_DATA_WITH_PURCHASER_ID,
                                "stackHeight": None,
                            },
                        ],
                    },
