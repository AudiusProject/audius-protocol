...
remix_contest_ended_notification_action_data = ns.model(
    "remix_contest_ended_notification_action_data",
    {
        "entity_user_id": fields.String(required=True),
        "entity_id": fields.String(required=True),
    },
)
remix_contest_ended_notification_action = ns.clone(
    "remix_contest_ended_notification_action",
    notification_action_base,
    {
        "data": fields.Nested(
            remix_contest_ended_notification_action_data, required=True
        )
    },
)
remix_contest_ended_notification = ns.clone(
    "remix_contest_ended_notification",
    notification_base,
    {
        "actions": fields.List(
            fields.Nested(remix_contest_ended_notification_action, required=True),
            required=True,
        )
    },
)

remix_contest_ending_soon_notification_action_data = ns.model(
    "remix_contest_ending_soon_notification_action_data",
    {
        "entity_user_id": fields.String(required=True),
        "entity_id": fields.String(required=True),
    },
)
remix_contest_ending_soon_notification_action = ns.clone(
    "remix_contest_ending_soon_notification_action",
    notification_action_base,
    {
        "data": fields.Nested(
            remix_contest_ending_soon_notification_action_data, required=True
        )
    },
)
remix_contest_ending_soon_notification = ns.clone(
    "remix_contest_ending_soon_notification",
    notification_base,
    {
        "actions": fields.List(
            fields.Nested(remix_contest_ending_soon_notification_action, required=True),
            required=True,
        )
    },
)
