...
class ValidatorRegistration(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["comet_address", b"comet_address", "endpoint", b"endpoint", "eth_block", b"eth_block", "node_type", b"node_type", "sp_id", b"sp_id"]) -> None: ...
...
class TrackPlay(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["signature", b"signature", "timestamp", b"timestamp", "track_id", b"track_id", "user_id", b"user_id"]) -> None: ...
