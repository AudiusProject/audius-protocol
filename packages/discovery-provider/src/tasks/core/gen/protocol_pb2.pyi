...
class SignedTransaction(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["manage_entity", b"manage_entity", "plays", b"plays", "sla_rollup", b"sla_rollup", "transaction", b"transaction", "validator_deregistration", b"validator_deregistration", "validator_registration", b"validator_registration"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["manage_entity", b"manage_entity", "plays", b"plays", "request_id", b"request_id", "signature", b"signature", "sla_rollup", b"sla_rollup", "transaction", b"transaction", "validator_deregistration", b"validator_deregistration", "validator_registration", b"validator_registration"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["transaction", b"transaction"]) -> typing.Literal["plays", "validator_registration", "sla_rollup", "manage_entity", "validator_deregistration"] | None: ...
...
class BlockResponse(google.protobuf.message.Message):
    ...
    @property
    def transactions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___TransactionResponse]: ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        proposer: builtins.str = ...,
        height: builtins.int = ...,
        transactions: collections.abc.Iterable[global___TransactionResponse] | None = ...,
        current_height: builtins.int = ...,
