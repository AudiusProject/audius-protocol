...
from src.tasks.metadata import (
    ...
    collectibles_data_metadata_format,
...
class ExistingRecordDict(TypedDict):
    ...
    CollectiblesData: Dict[int, CollectiblesData]
...
def get_metadata_type_and_format(entity_type, action=None):
    ...
    elif entity_type == EntityType.COLLECTIBLES_DATA:
        metadata_type = "collectibles_data"
        metadata_format = collectibles_data_metadata_format
    else:
