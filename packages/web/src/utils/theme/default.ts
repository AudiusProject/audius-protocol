const theme = {
  ...
  '--nav-column-group-header': 'var(--harmony-n-400)',
  '--nav-column-link': 'var(--harmony-n-950)',
  '--nav-column-link-hover': 'var(--harmony-n-950)',
  ...
  '--default-profile-picture-background': 'var(--harmony-n-400)',
