...
// This loading page shows up when the user's account is still being created either due to slow creation or a fast user
...
export const LoadingAccountPage = () => {
  ...
  }, [navigate, setIsWelcomeModalOpen, accountCreationStatus])
