...
> = {
  ...
  referred: {
    ...
    description: (challenge) => `You earned ${challenge?.totalAmount ?? ''} $AUDIO for being invited.`,
    fullDescription: (challenge) => `You earned ${challenge?.totalAmount ?? ''} $AUDIO for being invited.`,
