...
const deriveClaimableTokenAuthority = async () => {
    return (await SolanaUtils.findProgramAddressFromPubkey(SolanaUtils.newPublicKeyNullable(solanaClaimableTokenProgramAddress), SolanaUtils.newPublicKeyNullable(solanaMintAddress)))[0].toString();
};
