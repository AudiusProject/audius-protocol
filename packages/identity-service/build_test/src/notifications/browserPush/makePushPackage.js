...
const websiteJson = pushLib.websiteJSON(config.websiteName, config.websitePushID, [config.appUrl, config.identityUrl, ...config.appUrls], // allowedDomains
...
pushLib
    .generatePackage(websiteJson, // The object from before / your own website.json object
