...
const AudiusImage = () => {
    return (<img src='https://gallery.mailchimp.com/f351897a27ff0a641b8acd9ab/images/b1070e55-9487-4acb-abce-e755484cce46.png' style={{ maxWidth: '240px', margin: '27px auto' }} alt='Audius Logo'/>);
};
const WhatYouMissed = () => {
    return (<img src='https://download.audius.co/static-resources/email/whatYouMissed.png' style={{
            maxWidth: '490px',
            margin: '0px auto 7px'
        }} alt='What You Missed'/>);
};
const UnreadNotifications = ({ message }) => (<p className={'avenir'} style={{
...
const Body = (props) => {
    return (<body bgcolor='#FFFFFF' style={{ backgroundColor: '#FFFFFF' }}>
      <p style={{
            display: 'none',
            fontSize: '1px',
            color: '#333333',
        ...
        <table align='center' border='0' cellpadding='0' cellspacing='0' width='100%' id='bodyTable' bgcolor='#FFFFFF' style={{ backgroundColor: '#FFFFFF' }}>
          ...
          <tr>
            ...
            marginBottom: '32px'
              ...
              {props.notifications.map((notification, ind) => (<Notification_1.default key={ind} {...mapNotification(notification)}/>))}
            </td>
          </tr>
          <tr>
              ...
              <table cellspacing='0' cellpadding='0' style={{ margin: '0px auto' }}>
                <tr>
                  <td style={{ borderRadius: '17px', margin: '0px auto' }} bgcolor='#7E1BCC'>
                    <a href='https://audius.co/feed?openNotifications=true' target='_blank' style={{
            padding: '8px 24px',
            fontSize: '14px',
            color: '#ffffff',
            textDecoration: 'none',
          ...
          <tr>
            <td style={{ paddingBottom: '25px' }}>
              <Footer_1.default copyrightYear={props.copyrightYear}/>
            </td>
          </tr>
        </table>
      </center>
