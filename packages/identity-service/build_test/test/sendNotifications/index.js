...
describe('Test Send Notifications', function () {
    ...
    it('should have the correct trending track notifications', async function () {
        ...
        await models.UserNotificationMobileSettings.update({ milestonesAndAchievements: false }, { where: { userId: 3 } });
        const tx1 = await models.sequelize.transaction();
    ...
    it('should have the correct create notifications', async function () {
        ...
        await models.Subscription.bulkCreate([
            { subscriberId: 3, userId: 1 },
            { subscriberId: 4, userId: 1 },
    ...
    it('should have the correct reward notifications', async function () {
        ...
        for (const n of notifs) {
            assert.deepStrictEqual(pushNotifications.some(queueNotif => queueNotif.notificationParams.title === n.title && queueNotif.notificationParams.message === n.msg), true);
        }
