...
module.exports = function (app) {
    app.get('/scores', userHandleMiddleware, handleResponse(async (req) => {
        ...
        const captchaScores = await models.sequelize.query(`select "Users"."blockchainUserId" as "userId", "BotScores"."recaptchaScore" as "score", "BotScores"."recaptchaContext" as "context", "BotScores"."updatedAt" as "updatedAt"
      from 
      ...
      where
        ...
        const cognitoFlowScores = await models.sequelize.query(`select "Users"."blockchainUserId" as "userId", "CognitoFlows"."score" as "score"
      from 
