...
const sendEthTransaction = async (req, txProps, reqBodySHA) => {
    ...
    const { selectedEthRelayerWallet, ethWalletIndex } = await selectEthWallet(senderAddress, logger);
    ...
    try {
        ...
        }, contractAddress, '0x00', ethWeb3, req.logger, ethRelayGasPrice, gasLimit, encodedABI);
    }
    catch (e) {
