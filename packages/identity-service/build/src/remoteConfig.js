...
const getRemoteVar = (optimizelyClient, variable) => {
    ...
    return optimizelyClient.getFeatureVariable(REMOTE_CONFIG_FEATURE, variable, DUMMY_USER_ID);
};
/**
...
const getRemoteFeatureVarEnabled = (optimizelyClient, feature, variable) => {
    ...
    return optimizelyClient.getFeatureVariableBoolean(feature, variable, DUMMY_USER_ID);
};
module.exports = {
    getRemoteVar,
    REMOTE_VARS,
