...
const notificationMap = ((_notificationMap = {}),
    _defineProperty(_notificationMap, _constants.notificationTypes.Favorite.base, function (notification) {
    ...
    _defineProperty(_notificationMap, _constants.notificationTypes.ChallengeReward, function (notification) {
        ...
        const _challengeRewardsConf = challengeRewardsConfig[notification.challengeId];
    ...
    switch (notification.type) {
        case _constants.notificationTypes.RemixCreate: {
            ...
            const text = 'New remix of '
                ...
                .concat(twitterHandle, ' on @AudiusProject #Audius');
        ...
        case _constants.notificationTypes.RemixCosign: {
            ...
            const _text = 'My remix of '
                ...
                .concat(_twitterHandle, ' on @AudiusProject #Audius');
            return {
                message: 'Share With Your Friends',
                href: 'http://twitter.com/share?url='
        ...
        case _constants.notificationTypes.TrendingTrack: {
            ...
            const _text2 = 'My track '
                ...
                .concat(rank)
                .concat(rankSuffix, ' on @AudiusProject! #AudiusTrending #Audius');
            return {
        ...
        case _constants.notificationTypes.ChallengeReward: {
            const _text3 = 'I earned $AUDIO for completing challenges on @AudiusProject #AudioRewards';
            return {
