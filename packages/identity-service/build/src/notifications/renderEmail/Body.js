...
const _Footer = _interopRequireDefault(require('./Footer'));
const _Notification = _interopRequireDefault(require('./notifications/Notification'));
...
const AudiusImage = function AudiusImage() {
...
const WhatYouMissed = function WhatYouMissed() {
    return /* #__PURE__ */ _react.default.createElement('img', {
...
const UnreadNotifications = function UnreadNotifications(_ref) {
...
const getNumberSuffix = function getNumberSuffix(num) {
    if (num === 1)
        return 'st';
    else if (num === 2)
        return 'nd';
...
const snippetMap = ((_snippetMap = {}),
    _defineProperty(_snippetMap, _constants.notificationTypes.Favorite.base, function (notification) {
        const _notification$users = _slicedToArray(notification.users, 1);
        const user = _notification$users[0];
        return ''
            .concat(user.name, ' favorited your ')
            .concat(notification.entity.type.toLowerCase(), ' ')
    ...
    _defineProperty(_snippetMap, _constants.notificationTypes.Repost.base, function (notification) {
        const _notification$users2 = _slicedToArray(notification.users, 1);
        const user = _notification$users2[0];
        return ''
            .concat(user.name, ' reposted your ')
            .concat(notification.entity.type.toLowerCase(), ' ')
            .concat(notification.entity.name);
    }),
    _defineProperty(_snippetMap, _constants.notificationTypes.Follow, function (notification) {
        const _notification$users3 = _slicedToArray(notification.users, 1);
        const user = _notification$users3[0];
    ...
    _defineProperty(_snippetMap, _constants.notificationTypes.Milestone, function (notification) {
        if (notification.entity) {
            ...
            return 'Your '
                .concat(entity, ' ')
                .concat(notification.entity.name, ' has reached over ')
                .concat(notification.value, ' ')
    ...
    _defineProperty(_snippetMap, _constants.notificationTypes.TrendingTrack, function (notification) {
        ...
        return 'Your Track '
            .concat(notification.entity.title, ' is ')
            .concat(notification.rank)
            .concat(suffix, ' on Trending Right Now!');
    }),
    _defineProperty(_snippetMap, _constants.notificationTypes.UserSubscription, function (notification) {
        const _notification$users4 = _slicedToArray(notification.users, 1);
        const user = _notification$users4[0];
        if (notification.entity.type === _constants.notificationTypes.Track &&
            !isNaN(notification.entity.count) &&
            notification.entity.count > 1) {
            return ''
                .concat(user.name, ' released ')
                .concat(notification.entity.count, ' new ')
                .concat(notification.entity.type);
        }
        return ''
            .concat(user.name, ' released a new ')
            .concat(notification.entity.type.toLowerCase(), ' ')
            .concat(notification.entity.name);
    }),
    ...
    _defineProperty(_snippetMap, _constants.notificationTypes.RemixCosign, function (notification) {
        ...
        return ''
            .concat(parentTrackUser.name, ' Co-signed your Remix of ')
            .concat(parentTrack.title);
    }),
    ...
    _defineProperty(_snippetMap, _constants.notificationTypes.AddTrackToPlaylist, function (notification) {
        return ''
            .concat(notification.playlistOwner.name, ' added ')
            .concat(notification.track.title, ' to ')
            .concat(notification.playlist.playlist_name);
    }),
    _defineProperty(_snippetMap, _constants.notificationTypes.TipReceive, function (notification) {
        return ''
            .concat(notification.sendingUser.name, ' sent you a tip of ')
            .concat(notification.amount, ' $AUDIO');
    }),
    _defineProperty(_snippetMap, _constants.notificationTypes.Reaction, function (notification) {
        return ''
            .concat(notification.reactingUser.name, ' reacted to your tip of ')
            .concat(notification.amount, ' $AUDIO');
    }),
    _defineProperty(_snippetMap, _constants.notificationTypes.SupporterRankUp, function (notification) {
        return ''
            .concat(notification.sendingUser.name, ' became your #')
            .concat(notification.rank, ' top supporter');
    }),
    _defineProperty(_snippetMap, _constants.notificationTypes.SupportingRankUp, function (notification) {
        return "You're now "
            .concat(notification.receivingUser.name, "'s #")
            .concat(notification.rank, ' top supporter');
    }),
    _snippetMap);
const mapNotification = function mapNotification(notification) {
...
const getSnippet = function getSnippet(notifications) {
    const snippet = notifications
        ...
        .join(', ');
    if (snippet.length <= SNIPPET_ELLIPSIS_LENGTH)
        return snippet;
    const indexOfEllipsis = snippet.substring(SNIPPET_ELLIPSIS_LENGTH).indexOf(' ') +
...
const Body = function Body(props) {
    ...
    /* #__PURE__ */ _react.default.createElement('center', null, 
    ...
    /* #__PURE__ */ _react.default.createElement('tr', null, 
    /* #__PURE__ */ _react.default.createElement('td', {
        align: 'center',
        valign: 'top',
        id: 'bodyCell'
    }, 
    /* #__PURE__ */ _react.default.createElement(AudiusImage, null))), 
    /* #__PURE__ */ _react.default.createElement('tr', null, 
    /* #__PURE__ */ _react.default.createElement('td', {
        align: 'center',
        valign: 'top',
    ...
    /* #__PURE__ */ _react.default.createElement(WhatYouMissed, null))), 
    /* #__PURE__ */ _react.default.createElement('tr', null, 
    /* #__PURE__ */ _react.default.createElement('td', {
        align: 'center',
        valign: 'top',
