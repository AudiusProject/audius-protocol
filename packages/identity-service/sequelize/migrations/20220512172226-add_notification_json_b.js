...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    return queryInterface.sequelize.query(
      `ALTER TYPE "enum_SolanaNotifications_type" ADD VALUE 'TipSend'`)
      .then(() =>
        queryInterface.sequelize.query(`ALTER TYPE "enum_SolanaNotifications_type" ADD VALUE 'TipReceive'`)
      ).then(() =>
        queryInterface.sequelize.query(`ALTER TYPE "enum_SolanaNotifications_type" ADD VALUE 'Reaction'`)
      ).then(() =>
        queryInterface.sequelize.query(`ALTER TYPE "enum_SolanaNotifications_type" ADD VALUE 'SupporterRankUp'`)
      ).then(() =>
        queryInterface.sequelize.query(`ALTER TYPE "enum_SolanaNotifications_type" ADD VALUE 'SupportingRankUp'`)
