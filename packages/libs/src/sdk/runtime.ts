...
/** NOTE: This is an archived copy of the generated `runtime.ts` file from our OpenAPI spec. It's only here
 * to provide legacy types for libs services until libs is removed. Do not use this file for new code.
 */
