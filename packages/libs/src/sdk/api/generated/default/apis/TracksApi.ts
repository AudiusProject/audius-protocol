...
export class TracksApi extends runtime.BaseAPI {
   ...
   */
  async downloadTrackRaw(
    params: DownloadTrackRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (params.trackId === null || params.trackId === undefined) {
      throw new runtime.RequiredError(
        'trackId',
        'Required parameter params.trackId was null or undefined when calling downloadTrack.'
      )
    }
  ...
  async getBulkTracksRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<TracksResponse>> {
    const queryParameters: any = {}
  ...
  async getTrackRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<TrackResponse>> {
    if (params.trackId === null || params.trackId === undefined) {
      throw new runtime.RequiredError(
        'trackId',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      TrackResponseFromJSON(jsonValue)
    )
  }
   ...
   */
  async getTrackAccessInfoRaw(
    params: GetTrackAccessInfoRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AccessInfoResponse>> {
    if (params.trackId === null || params.trackId === undefined) {
      throw new runtime.RequiredError(
        'trackId',
        'Required parameter params.trackId was null or undefined when calling getTrackAccessInfo.'
      )
    }
    ...
    const response = await this.request(
      {
        path: `/tracks/{track_id}/access-info`.replace(
          `{${'track_id'}}`,
          encodeURIComponent(String(params.trackId))
        ),
        method: 'GET',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AccessInfoResponseFromJSON(jsonValue)
    )
  }
   ...
   * Gets the information necessary to access the track and what access the given user has.
   */
  async getTrackAccessInfo(
    params: GetTrackAccessInfoRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AccessInfoResponse> {
  ...
  async getTrackTopListenersRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<TopListener>> {
    if (params.trackId === null || params.trackId === undefined) {
      throw new runtime.RequiredError(
        'trackId',
   ...
   */
  async inspectTrackRaw(
    params: InspectTrackRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<TrackInspect>> {
    if (params.trackId === null || params.trackId === undefined) {
      throw new runtime.RequiredError(
        'trackId',
        'Required parameter params.trackId was null or undefined when calling inspectTrack.'
      )
    }
    ...
    const response = await this.request(
      {
        path: `/tracks/{track_id}/inspect`.replace(
          `{${'track_id'}}`,
          encodeURIComponent(String(params.trackId))
        ),
        method: 'GET',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      TrackInspectFromJSON(jsonValue)
    )
  }
  ...
  async searchTracksRaw(
    params: SearchTracksRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<TrackSearch>> {
    const queryParameters: any = {}
   ...
   */
  async streamTrackRaw(
    params: StreamTrackRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (params.trackId === null || params.trackId === undefined) {
      throw new runtime.RequiredError(
        'trackId',
        'Required parameter params.trackId was null or undefined when calling streamTrack.'
      )
    }
    ...
    const response = await this.request(
      {
        path: `/tracks/{track_id}/stream`.replace(
          `{${'track_id'}}`,
          encodeURIComponent(String(params.trackId))
        ),
        method: 'GET',
   ...
   */
  async trackCommentsRaw(
    params: TrackCommentsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<TrackCommentsResponse>> {
    if (params.trackId === null || params.trackId === undefined) {
      throw new runtime.RequiredError(
        'trackId',
        'Required parameter params.trackId was null or undefined when calling trackComments.'
      )
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      TrackCommentsResponseFromJSON(jsonValue)
    )
  }
...
export type SearchTracksSortMethodEnum =
  (typeof SearchTracksSortMethodEnum)[keyof typeof SearchTracksSortMethodEnum]
