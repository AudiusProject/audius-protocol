...
import { RepostFromJSON, RepostFromJSONTyped, RepostToJSON } from './Repost'
...
export function TrackFullFromJSONTyped(
  json: any,
  ...
  return {
    artwork: !exists(json, 'artwork')
      ? undefined
      : TrackArtworkFromJSON(json['artwork']),
    ...
    releaseDate: !exists(json, 'release_date')
      ? undefined
      : json['release_date'],
    remixOf: !exists(json, 'remix_of')
      ? undefined
      : FullRemixParentFromJSON(json['remix_of']),
    ...
    downloadable: !exists(json, 'downloadable')
      ? undefined
      : json['downloadable'],
    playCount: json['play_count'],
    permalink: !exists(json, 'permalink') ? undefined : json['permalink'],
    isStreamable: !exists(json, 'is_streamable')
      ? undefined
      : json['is_streamable'],
    blocknumber: json['blocknumber'],
    createDate: !exists(json, 'create_date') ? undefined : json['create_date'],
    coverArtSizes: !exists(json, 'cover_art_sizes')
      ? undefined
      : json['cover_art_sizes'],
    coverArtCids: !exists(json, 'cover_art_cids')
      ? undefined
      : CoverArtFromJSON(json['cover_art_cids']),
    createdAt: !exists(json, 'created_at') ? undefined : json['created_at'],
    creditsSplits: !exists(json, 'credits_splits')
      ? undefined
      : json['credits_splits'],
    download: !exists(json, 'download')
      ? undefined
      : DownloadMetadataFromJSON(json['download']),
    isrc: !exists(json, 'isrc') ? undefined : json['isrc'],
    license: !exists(json, 'license') ? undefined : json['license'],
    iswc: !exists(json, 'iswc') ? undefined : json['iswc'],
    fieldVisibility: !exists(json, 'field_visibility')
      ? undefined
      : FieldVisibilityFromJSON(json['field_visibility']),
    followeeReposts: (json['followee_reposts'] as Array<any>).map(
      RepostFromJSON
    ),
    ...
    followeeFavorites: (json['followee_favorites'] as Array<any>).map(
      FavoriteFromJSON
    ),
    routeId: json['route_id'],
    stemOf: !exists(json, 'stem_of')
      ? undefined
      : StemParentFromJSON(json['stem_of']),
    trackSegments: !exists(json, 'track_segments')
      ? undefined
      : (json['track_segments'] as Array<any>).map(TrackSegmentFromJSON),
    ...
    isAvailable: !exists(json, 'is_available')
      ? undefined
      : json['is_available'],
    isPremium: !exists(json, 'is_premium') ? undefined : json['is_premium'],
    premiumConditions: !exists(json, 'premium_conditions')
      ? undefined
      : json['premium_conditions'],
    premiumContentSignature: !exists(json, 'premium_content_signature')
      ? undefined
      : PremiumContentSignatureFromJSON(json['premium_content_signature']),
    aiAttributionUserId: !exists(json, 'ai_attribution_user_id')
      ? undefined
      : json['ai_attribution_user_id'],
    audioUploadId: !exists(json, 'audio_upload_id')
      ? undefined
      : json['audio_upload_id'],
    previewStartSeconds: !exists(json, 'preview_start_seconds')
      ? undefined
      : json['preview_start_seconds'],
    parentAlbumIds: !exists(json, 'parent_album_ids')
      ? undefined
      : json['parent_album_ids']
  }
}
...
export function TrackFullToJSON(value?: TrackFull | null): any {
  ...
  return {
    ...
    followee_favorites: (value.followeeFavorites as Array<any>).map(
      FavoriteToJSON
    ),
    route_id: value.routeId,
    stem_of: StemParentToJSON(value.stemOf),
    track_segments:
      value.trackSegments === undefined
        ? undefined
        : (value.trackSegments as Array<any>).map(TrackSegmentToJSON),
    ...
    premium_content_signature: PremiumContentSignatureToJSON(
      value.premiumContentSignature
    ),
    ...
    parent_album_ids: value.parentAlbumIds
  }
}
