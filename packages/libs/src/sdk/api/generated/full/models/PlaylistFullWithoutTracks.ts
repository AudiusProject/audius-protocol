...
export function PlaylistFullWithoutTracksFromJSON(
  json: any
...
export function PlaylistFullWithoutTracksFromJSONTyped(
  ...
  return {
    artwork: !exists(json, 'artwork')
      ? undefined
      : PlaylistArtworkFromJSON(json['artwork']),
    ...
    playlistContents: (json['playlist_contents'] as Array<any>).map(
      PlaylistAddedTimestampFromJSON
    ),
    ...
    addedTimestamps: (json['added_timestamps'] as Array<any>).map(
      PlaylistAddedTimestampFromJSON
    ),
    userId: json['user_id'],
    tracks: !exists(json, 'tracks')
      ? undefined
      : (json['tracks'] as Array<any>).map(TrackFullFromJSON),
    ...
    coverArtCids: !exists(json, 'cover_art_cids')
      ? undefined
      : PlaylistArtworkFromJSON(json['cover_art_cids']),
    trackCount: json['track_count']
  }
}

export function PlaylistFullWithoutTracksToJSON(
  value?: PlaylistFullWithoutTracks | null
): any {
  if (value === undefined) {
    return undefined
  }
  ...
  return {
    ...
    playlist_contents: (value.playlistContents as Array<any>).map(
      PlaylistAddedTimestampToJSON
    ),
    ...
    added_timestamps: (value.addedTimestamps as Array<any>).map(
      PlaylistAddedTimestampToJSON
    ),
    ...
    tracks:
      value.tracks === undefined
        ? undefined
        : (value.tracks as Array<any>).map(TrackFullToJSON),
