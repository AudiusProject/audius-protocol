...
describe('Sign in', function () {
    ...
    it('can navigate to sign-in from sign-up', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, expect(byRole('heading', { name: /sign into audius/i })).toBeVisible()];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('can sign in', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(byRole('heading', { name: /sign up for audius/i })).toBeVisible()];
                case 1:
                ...
                case 5:
                    _a.sent();
                    return [4 /*yield*/, byRole('button', { name: /sign in/i }).tap()];
                case 6:
                    _a.sent();
                    return [4 /*yield*/, waitFor(element(by.label(/turn on notifications/i)))
                            .toBeVisible()
                            .withTimeout(15000)];
                case 7:
                    _a.sent();
