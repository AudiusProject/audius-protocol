...
export var RepeatListener = function () {
    var dispatch = useDispatch();
    var position = useProgress().position;
    var previousPosition = usePrevious(position);
            ...
            switch (_a.label) {
                case 0:
                    if (!(previousPosition !== undefined &&
                        ...
                        position < 1)) return [3 /*break*/, 2];
                    return [4 /*yield*/, TrackPlayer.getRepeatMode()];
                case 1:
                    // Manually increment player count if we are repeating
                    if ((_a.sent()) === RepeatMode.Track) {
