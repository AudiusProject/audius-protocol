...
export var CollectionCardSkeleton = function () {
    return (<Paper border='default'>
      ...
      <Flex pv='s' backgroundColor='surface1' alignItems='center' borderBottomLeftRadius='m' borderBottomRightRadius='m'>
