...
import { forceRefreshConnectivity, subscribeToNetworkStatusUpdates } from 'app/utils/reachability';
...
var Airplay = (_a = Platform.select({
    ios: function () { return require('../components/audio/Airplay').default; },
    android: function () { return function () { return null; }; }
...
var AppWithSentry = Sentry.wrap(App);
