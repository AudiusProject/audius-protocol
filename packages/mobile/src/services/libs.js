...
export var libsInitEventEmitter = new EventEmitter();
export var audiusLibs = null;
export var LIBS_INITTED_EVENT = 'LIBS_INITTED_EVENT';
export var setLibs = function (libs) { return (audiusLibs = libs); };
/**
 * Wait for the `LIBS_INITTED_EVENT` or pass through if there
 * already exists a mounted `window.audiusLibs` object.
 */
export var waitForLibsInit = function () { return __awaiter(void 0, void 0, void 0, function () {
