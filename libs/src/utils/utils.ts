...
import { importDataContractABIs, importEthContractABIs } from './importContractABI'
 ...
 */
  ...
  static async configureWeb3 (web3Provider: string, chainNetworkId: string, requiresAccount = true) {
