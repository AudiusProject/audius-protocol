...
describe('Test computeSyncModeForUserAndReplica()', function () {
  ...
  it('Returns SYNC_MODES.PrimaryShouldSync if clocks equal and filesHashes unequal', async function () {
    primaryClock = 10
    secondaryClock = primaryClock
    primaryFilesHash = '0x123'
    ...
    assert.strictEqual(syncMode, SYNC_MODES.PrimaryShouldSync)
  })

  it('Returns SYNC_MODES.PrimaryShouldSync if primaryClock < secondaryClock', async function () {
    primaryClock = 5
    secondaryClock = 10
    primaryFilesHash = '0x123'
    secondaryFilesHash = '0x456'
  ...
  it('Returns SYNC_MODES.SecondaryShouldSync if primaryClock > secondaryClock & secondaryFilesHash === null', async function () {
    primaryClock = 10
    secondaryClock = 5
    primaryFilesHash = '0x123'
    ...
    assert.strictEqual(syncMode, SYNC_MODES.SecondaryShouldSync)
  })

  describe('primaryClock > secondaryClock', function () {
    it('Returns SYNC_MODES.SecondaryShouldSync if primaryFilesHashForRange = secondaryFilesHash', async function () {
      primaryClock = 10
      secondaryClock = 5
      primaryFilesHash = '0x123'
      secondaryFilesHash = '0x456'
    ...
    it('Returns SYNC_MODES.PrimaryShouldSync if primaryFilesHashForRange != secondaryFilesHash', async function () {
      primaryClock = 10
      secondaryClock = 5
      primaryFilesHash = '0x123'
      secondaryFilesHash = '0x456'
