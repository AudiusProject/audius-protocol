...
describe('test secondarySyncHealthTracker', function () {
  ...
  it('[computeUsersSecondarySyncSuccessRatesForToday] should return 100% success rate for 1 success and 0 failures', async function () {
  ...
  it('[computeUsersSecondarySyncSuccessRatesForToday] should return 50% success rate for 1 success and 1 failure', async function () {
    const wallet = 'testWallet1'
    const secondary = 'http://secondary1.co'
    const syncType = 'testSyncType'
  ...
  it('[computeUsersSecondarySyncSuccessRatesForToday] should return 0% success rate for 0 successes and 1 failure', async function () {
    const wallet = 'testWallet1'
    const secondary = 'http://secondary1.co'
    const syncType = 'testSyncType'
  ...
  it('[computeUsersSecondarySyncSuccessRatesForToday] only returns wallets and secondaries requested', async function () {
    const wallet = 'testWallet1'
