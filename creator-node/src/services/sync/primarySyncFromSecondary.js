 ...
 */
async function _saveFilesToDisk({ files, userReplicaSet, libs, logger }) {
 ...
 */
async function _saveEntriesToDB({ fetchedCNodeUser, logger, logPrefix }) {
...
const saveEntriesToDB = instrumentTracing({
  fn: _saveEntriesToDB
})
