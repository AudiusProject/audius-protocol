...
module.exports = {
  up: async (queryInterface, _Sequelize) => {
    ...
    await queryInterface.sequelize.query(
      ...
      `ALTER TABLE IF EXISTS AudiusUsers DROP CONSTRAINT IF EXISTS "Tracks_coverArtFileUUID_fkey ";`,
      { transaction }
    )

    await queryInterface.sequelize.query(
      `ALTER TABLE IF EXISTS AudiusUsers DROP CONSTRAINT IF EXISTS "Tracks_metadataFileUUID_fkey";`,
      { transaction }
    )
