...
pub const RAYDIUM_AMM_PROGRAM_ADDRESS: Pubkey = pubkey!("675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8");

// https://github.com/project-serum/serum-dex/blob/master/README.md#program-deployments
pub const SERUM_DEX_PROGRAM_ADDRESS: Pubkey = pubkey!("9xQeWvG816bUx9EPjHmaT23yvVM2ZWbrrpZb9PusVFin");

// https://solscan.io/token/9LzCMqDgTKYz9Drzqnpgee3SGa89up3a247ypMj2xrqM
pub const SOL_AUDIO_TOKEN_ADDRESS: Pubkey = pubkey!("9LzCMqDgTKYz9Drzqnpgee3SGa89up3a247ypMj2xrqM");
...
pub const AUDIO_USDC_SERUM_MARKET_ADDRESS: Pubkey = pubkey!("FxquLRmVMPXiS84FFSp8q5fbVExhLkX85yiXucyu7xSC");

// https://solscan.io/account/4EbdAfaShVDNeHm6GbXZX3xsKccRHdTbR5962Bvya8xt
pub const AUDIO_USDC_RAYDIUM_AMM_ADDRESS: Pubkey = pubkey!("4EbdAfaShVDNeHm6GbXZX3xsKccRHdTbR5962Bvya8xt");
