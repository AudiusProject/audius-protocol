...
yarn run ts-node cli/main.ts -f initContentNode \
    ...
    --cn-sp-id 1 
    # \
    # --cn-sp-private-key "$DELEGATE_PRIVATE_KEY_1" \
    # --eth-address "${DELEGATE_ETH_ADDRESS_1:-0x25A3Acd4758Ab107ea0Bd739382B8130cD1F204d}"
...
yarn run ts-node cli/main.ts -f initContentNode \
    ...
    --cn-sp-id 2 
    # \
    # --cn-sp-private-key "$DELEGATE_PRIVATE_KEY_2" \
    # --eth-address "${DELEGATE_ETH_ADDRESS_1:-0x71B55d7bDe40D751087A27e2072F0fF8cacA400a}"
...
yarn run ts-node cli/main.ts -f initContentNode \
    ...
    --cn-sp-id 3 
    # \
    # --cn-sp-private-key "$DELEGATE_PRIVATE_KEY_3" \
    # --eth-address "${DELEGATE_ETH_ADDRESS_1:-0xb4bD6911d3F633A1F7B14D955E68061F6f845027}"
