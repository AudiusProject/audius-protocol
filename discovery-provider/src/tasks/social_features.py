...
def dispatch_challenge_repost(bus, repost, block_number):
    bus.queue_event(ChallengeEvent.repost, block_number, repost.user_id)


def dispatch_challenge_follow(bus, follow, block_number):
    bus.queue_event(ChallengeEvent.follow, block_number, follow.follower_user_id)
