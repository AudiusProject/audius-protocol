...
def update_route_metrics(db, redis):
...
def update_metrics(self):
    ...
    try:
        ...
        logger.error(
            "Fatal error in main loop of update_metrics", exc_info=True)
        raise e
    finally:
        if have_lock:
            update_lock.release()
