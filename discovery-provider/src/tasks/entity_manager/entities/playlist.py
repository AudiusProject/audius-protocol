...
def create_playlist(params: ManageEntityParameters):
    ...
    create_playlist_record = Playlist(
        ...
        is_playlist_image_autogenerated=params.metadata.get(
            "is_playlist_image_autogenerated", False
        ),
...
def process_playlist_data_event(
    ...
    if "is_playlist_image_autogenerated" in playlist_metadata:
        playlist_record.is_playlist_image_autogenerated = playlist_metadata[
            "is_playlist_image_autogenerated"
        ]
