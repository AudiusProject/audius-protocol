        ...
        if SECP_PROGRAM in tx_info["result"]["transaction"]["message"][
            ...
            for instruction in tx_info["result"]["transaction"]["message"][
                ...
                if instruction["programIdIndex"] == audius_program_index:
                    ...
                    user_id = codecs.decode(hex_data[start_data1:end_data1],
                                            "hex")
                    track_id = codecs.decode(hex_data[start_data2:end_data2],
                                             "hex")
                    source = codecs.decode(hex_data[start_data3:end_data3],
                                           "hex")
