...
def upgrade():
    ...
    sa.Column('repost_type', sa.Enum('track', 'playlist', 'album', name='reposttype'), nullable=False),
    ...
    sa.PrimaryKeyConstraint('is_current', 'user_id', 'repost_item_id', 'repost_type', 'blockhash')
    )
