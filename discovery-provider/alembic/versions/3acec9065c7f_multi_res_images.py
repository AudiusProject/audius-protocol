...
def upgrade():
    ...
    op.add_column('playlists', sa.Column('playlist_image_sizes_multihash', sa.String(), nullable=True))
    ...
    op.add_column('users', sa.Column('profile_picture_sizes', sa.String(), nullable=True))
