...
describe('Supporter Dethroned Notification', () => {
  ...
  test("Process push notification for tip receive", async () => {
    ...
    const reactionNotifications = pending.appNotifications.filter(n => n.type === 'supported_dethroned')
    ...
    expect(sendPushNotificationSpy).toHaveBeenCalledWith({
      ...
      body: `User_3 dethroned you as User_2's #1 Top Supporter! Tip to reclaim your spot?`,
      data: {}
    })
  })
