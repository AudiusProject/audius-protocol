...
import { CreatePlaylistNotification, CreateTrackNotification } from '../../types/notifications'
import { BaseNotification, Device, NotificationSettings } from './base'
import { sendPushNotification } from '../../sns'
import { ResourceIds, Resources } from '../../email/notifications/renderEmail'
import { EntityType } from '../../email/notifications/types'

type CreateNotificationRow = Omit<NotificationRow, 'data'> & { data: CreateTrackNotification | CreatePlaylistNotification }
export class Create extends BaseNotification<CreateNotificationRow> {
  ...
  constructor(dnDB: Knex, identityDB: Knex, notification: CreateNotificationRow) {
  ...
  async pushNotification() {
    ...
    if (this.trackId) {
      ...
      description = `${userName} released a new ${this.isAlbum ? 'album' : 'playlist'} ${playlist.playlist_name}`
    }
