...
type RepostOfRepostNotificationRow = Omit<NotificationRow, 'data'> & { data: RepostOfRepostNotification }
export class RepostOfRepost extends BaseNotification<RepostOfRepostNotificationRow> {
  ...
  constructor(dnDB: Knex, identityDB: Knex, notification: RepostOfRepostNotificationRow) {
