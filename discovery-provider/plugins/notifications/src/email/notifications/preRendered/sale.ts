							...
							<tr><td align="center" background="https://download.audius.co/support/i-464919331.png" style="background-image: url(https://download.audius.co/support/i-464919331.png); border-radius: 12px 12px 0px 0px;">
								...
								<div>
									...
									<tr><td align="center" valign="middle" class="outpadding" style="padding: 32px;">
										...
										<![endif]-->
										<div>
											<div style="line-height: 34px; word-break: break-all;">
												<span style="font-family: Inter, sans-serif; font-weight: bold; font-size: 28px; color: #ffffff;">Congratulations!</span>
											</div> 
											...
											<div>
												<div>
													...
													<tr><td align="left" valign="top">
														<div>
															<div style="line-height: 24px;">
																<span style="font-family: 'Avenir Next LT Pro', sans-serif; font-weight: bold; font-size: 20px; color: #858199;">Hello ${artistName},</span>
															</div> 
															<div style="height: 16px; line-height: 16px; font-size: 14px;">&nbsp;</div>
															<div style="line-height: 24px;">
																<span style="font-family: 'Avenir Next LT Pro', sans-serif; font-size: 18px; color: #858199;"><span style="text-decoration: none;">Congratulations! </span><span style="color: #7e1bcc; text-decoration: none;">${purchaserName} </span><span style="text-decoration: none;">just bought your track on Audius!</span></span>
															</div>
														</div>
													</td></tr>
													</table>
