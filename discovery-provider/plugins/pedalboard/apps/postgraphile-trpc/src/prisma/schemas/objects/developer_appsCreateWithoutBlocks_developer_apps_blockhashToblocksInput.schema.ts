...
const Schema: z.ZodType<Prisma.developer_appsCreateWithoutBlocks_developer_apps_blockhashToblocksInput> =
  z
    .object({
      address: z.string(),
...
export const developer_appsCreateWithoutBlocks_developer_apps_blockhashToblocksInputObjectSchema =
  Schema;
