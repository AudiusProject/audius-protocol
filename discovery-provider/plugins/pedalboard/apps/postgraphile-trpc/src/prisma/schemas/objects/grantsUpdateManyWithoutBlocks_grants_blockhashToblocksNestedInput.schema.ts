...
const Schema: z.ZodType<Prisma.grantsUpdateManyWithoutBlocks_grants_blockhashToblocksNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const grantsUpdateManyWithoutBlocks_grants_blockhashToblocksNestedInputObjectSchema =
  Schema;
