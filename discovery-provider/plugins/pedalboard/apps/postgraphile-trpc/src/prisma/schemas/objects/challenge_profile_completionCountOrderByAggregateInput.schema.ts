...
const Schema: z.ZodType<Prisma.challenge_profile_completionCountOrderByAggregateInput> =
  z
    .object({
...
export const challenge_profile_completionCountOrderByAggregateInputObjectSchema =
  Schema;
