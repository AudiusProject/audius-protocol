...
const Schema: z.ZodType<Prisma.track_delist_statusesMaxOrderByAggregateInput> =
  z
    .object({
...
export const track_delist_statusesMaxOrderByAggregateInputObjectSchema = Schema;
