...
const Schema: z.ZodType<Prisma.chat_message_reactionsUpsertWithWhereUniqueWithoutChat_messageInput> =
  z
    .object({
...
export const chat_message_reactionsUpsertWithWhereUniqueWithoutChat_messageInputObjectSchema =
  Schema;
