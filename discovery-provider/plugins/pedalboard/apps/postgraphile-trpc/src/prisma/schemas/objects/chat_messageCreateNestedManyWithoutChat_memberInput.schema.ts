...
const Schema: z.ZodType<Prisma.chat_messageCreateNestedManyWithoutChat_memberInput> =
  z
    .object({
      create: z
        .union([
...
export const chat_messageCreateNestedManyWithoutChat_memberInputObjectSchema =
  Schema;
