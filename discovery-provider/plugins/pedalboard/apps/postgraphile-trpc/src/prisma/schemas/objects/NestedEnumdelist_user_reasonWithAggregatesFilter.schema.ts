...
const Schema: z.ZodType<Prisma.NestedEnumdelist_user_reasonWithAggregatesFilter> =
  z
    .object({
...
export const NestedEnumdelist_user_reasonWithAggregatesFilterObjectSchema =
  Schema;
