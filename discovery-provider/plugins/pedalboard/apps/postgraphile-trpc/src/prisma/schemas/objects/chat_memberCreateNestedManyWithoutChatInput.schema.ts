...
const Schema: z.ZodType<Prisma.chat_memberCreateNestedManyWithoutChatInput> = z
  .object({
    create: z
      .union([
...
export const chat_memberCreateNestedManyWithoutChatInputObjectSchema = Schema;
