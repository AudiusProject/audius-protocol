...
const Schema: z.ZodType<Prisma.challenge_profile_completionOrderByWithRelationInput> =
  z
    .object({
...
export const challenge_profile_completionOrderByWithRelationInputObjectSchema =
  Schema;
