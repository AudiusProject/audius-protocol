...
const Schema: z.ZodType<Prisma.audio_transactions_historyOrderByWithRelationInput> =
  z
    .object({
...
export const audio_transactions_historyOrderByWithRelationInputObjectSchema =
  Schema;
