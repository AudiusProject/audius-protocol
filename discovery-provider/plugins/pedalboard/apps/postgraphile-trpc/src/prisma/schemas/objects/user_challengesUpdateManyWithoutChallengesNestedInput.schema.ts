...
const Schema: z.ZodType<Prisma.user_challengesUpdateManyWithoutChallengesNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const user_challengesUpdateManyWithoutChallengesNestedInputObjectSchema =
  Schema;
