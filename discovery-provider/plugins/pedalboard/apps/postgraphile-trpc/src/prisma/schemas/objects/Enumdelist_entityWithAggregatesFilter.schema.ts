...
import { NestedEnumdelist_entityWithAggregatesFilterObjectSchema } from './NestedEnumdelist_entityWithAggregatesFilter.schema';
import { NestedIntFilterObjectSchema } from './NestedIntFilter.schema';
import { NestedEnumdelist_entityFilterObjectSchema } from './NestedEnumdelist_entityFilter.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.Enumdelist_entityWithAggregatesFilter> = z
  .object({
...
export const Enumdelist_entityWithAggregatesFilterObjectSchema = Schema;
