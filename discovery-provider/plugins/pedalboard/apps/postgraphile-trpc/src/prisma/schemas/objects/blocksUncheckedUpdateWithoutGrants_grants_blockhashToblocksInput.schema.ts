...
const Schema: z.ZodType<Prisma.blocksUncheckedUpdateWithoutGrants_grants_blockhashToblocksInput> =
  z
    .object({
      blockhash: z
        .union([
...
export const blocksUncheckedUpdateWithoutGrants_grants_blockhashToblocksInputObjectSchema =
  Schema;
