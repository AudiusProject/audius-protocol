...
const Schema: z.ZodType<Prisma.Audio_transactions_historyMaxAggregateInputType> =
  z
    .object({
...
export const Audio_transactions_historyMaxAggregateInputObjectSchema = Schema;
