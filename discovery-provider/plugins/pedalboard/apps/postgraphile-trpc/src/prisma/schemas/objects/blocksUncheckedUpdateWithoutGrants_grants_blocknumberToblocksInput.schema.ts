...
const Schema: z.ZodType<Prisma.blocksUncheckedUpdateWithoutGrants_grants_blocknumberToblocksInput> =
  z
    .object({
      blockhash: z
        .union([
...
export const blocksUncheckedUpdateWithoutGrants_grants_blocknumberToblocksInputObjectSchema =
  Schema;
