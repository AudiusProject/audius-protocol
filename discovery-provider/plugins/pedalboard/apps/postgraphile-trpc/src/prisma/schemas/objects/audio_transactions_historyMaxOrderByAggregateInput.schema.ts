...
const Schema: z.ZodType<Prisma.audio_transactions_historyMaxOrderByAggregateInput> =
  z
    .object({
...
export const audio_transactions_historyMaxOrderByAggregateInputObjectSchema =
  Schema;
