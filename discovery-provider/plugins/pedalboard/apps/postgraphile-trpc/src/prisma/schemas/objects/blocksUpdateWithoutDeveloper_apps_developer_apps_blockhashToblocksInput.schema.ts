...
const Schema: z.ZodType<Prisma.blocksUpdateWithoutDeveloper_apps_developer_apps_blockhashToblocksInput> =
  z
    .object({
      blockhash: z
        .union([
...
export const blocksUpdateWithoutDeveloper_apps_developer_apps_blockhashToblocksInputObjectSchema =
  Schema;
