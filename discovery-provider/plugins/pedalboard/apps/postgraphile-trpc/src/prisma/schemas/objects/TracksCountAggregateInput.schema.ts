...
const Schema: z.ZodType<Prisma.TracksCountAggregateInputType> = z
  .object({
    ...
    track_segments: z.literal(true).optional(),
    ...
    download: z.literal(true).optional(),
    is_unlisted: z.literal(true).optional(),
    field_visibility: z.literal(true).optional(),
    route_id: z.literal(true).optional(),
    stem_of: z.literal(true).optional(),
    remix_of: z.literal(true).optional(),
    ...
    premium_conditions: z.literal(true).optional(),
...
export const TracksCountAggregateInputObjectSchema = Schema;
