...
const Schema: z.ZodType<Prisma.track_delist_statusesUncheckedUpdateManyInput> =
  z
    .object({
      created_at: z
        .union([
...
export const track_delist_statusesUncheckedUpdateManyInputObjectSchema = Schema;
