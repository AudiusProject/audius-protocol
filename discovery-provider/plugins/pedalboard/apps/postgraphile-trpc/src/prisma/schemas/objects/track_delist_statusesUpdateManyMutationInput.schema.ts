...
const Schema: z.ZodType<Prisma.track_delist_statusesUpdateManyMutationInput> = z
  .object({
    created_at: z
      .union([
        z.coerce.date(),
...
export const track_delist_statusesUpdateManyMutationInputObjectSchema = Schema;
