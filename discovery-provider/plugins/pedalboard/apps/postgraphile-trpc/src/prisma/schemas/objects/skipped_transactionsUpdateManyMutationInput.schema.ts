...
const Schema: z.ZodType<Prisma.skipped_transactionsUpdateManyMutationInput> = z
  .object({
    blocknumber: z
      .union([
        z.number(),
...
export const skipped_transactionsUpdateManyMutationInputObjectSchema = Schema;
