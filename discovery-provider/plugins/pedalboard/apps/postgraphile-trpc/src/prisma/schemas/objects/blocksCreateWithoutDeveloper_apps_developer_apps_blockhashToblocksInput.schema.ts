...
const Schema: z.ZodType<Prisma.blocksCreateWithoutDeveloper_apps_developer_apps_blockhashToblocksInput> =
  z
    .object({
      blockhash: z.string(),
...
export const blocksCreateWithoutDeveloper_apps_developer_apps_blockhashToblocksInputObjectSchema =
  Schema;
