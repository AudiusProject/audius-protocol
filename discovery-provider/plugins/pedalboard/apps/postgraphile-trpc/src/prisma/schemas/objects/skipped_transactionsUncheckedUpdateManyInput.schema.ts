...
const Schema: z.ZodType<Prisma.skipped_transactionsUncheckedUpdateManyInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const skipped_transactionsUncheckedUpdateManyInputObjectSchema = Schema;
