...
const Schema: z.ZodType<Prisma.delist_status_cursorUpdateManyMutationInput> = z
  .object({
    host: z
      .union([
        z.string(),
...
export const delist_status_cursorUpdateManyMutationInputObjectSchema = Schema;
