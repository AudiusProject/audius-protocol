...
import { NestedEnumskippedtransactionlevelNullableWithAggregatesFilterObjectSchema } from './NestedEnumskippedtransactionlevelNullableWithAggregatesFilter.schema';
...
const Schema: z.ZodType<Prisma.EnumskippedtransactionlevelNullableWithAggregatesFilter> =
  z
    .object({
      equals: z
...
export const EnumskippedtransactionlevelNullableWithAggregatesFilterObjectSchema =
  Schema;
