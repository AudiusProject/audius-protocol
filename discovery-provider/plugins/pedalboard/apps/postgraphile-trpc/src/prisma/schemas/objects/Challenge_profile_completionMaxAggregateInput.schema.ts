...
const Schema: z.ZodType<Prisma.Challenge_profile_completionMaxAggregateInputType> =
  z
    .object({
...
export const Challenge_profile_completionMaxAggregateInputObjectSchema = Schema;
