...
const Schema: z.ZodType<Prisma.PlaylistsCountAggregateInputType> = z
  .object({
    ...
    playlist_contents: z.literal(true).optional(),
...
export const PlaylistsCountAggregateInputObjectSchema = Schema;
