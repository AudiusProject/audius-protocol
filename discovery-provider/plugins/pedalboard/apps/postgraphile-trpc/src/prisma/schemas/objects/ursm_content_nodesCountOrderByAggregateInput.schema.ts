...
const Schema: z.ZodType<Prisma.ursm_content_nodesCountOrderByAggregateInput> = z
  .object({
...
export const ursm_content_nodesCountOrderByAggregateInputObjectSchema = Schema;
