...
const Schema: z.ZodType<Prisma.Challenge_profile_completionCountAggregateInputType> =
  z
    .object({
...
export const Challenge_profile_completionCountAggregateInputObjectSchema =
  Schema;
