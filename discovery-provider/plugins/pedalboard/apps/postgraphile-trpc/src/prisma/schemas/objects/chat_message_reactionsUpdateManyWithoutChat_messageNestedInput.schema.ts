...
const Schema: z.ZodType<Prisma.chat_message_reactionsUpdateManyWithoutChat_messageNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const chat_message_reactionsUpdateManyWithoutChat_messageNestedInputObjectSchema =
  Schema;
