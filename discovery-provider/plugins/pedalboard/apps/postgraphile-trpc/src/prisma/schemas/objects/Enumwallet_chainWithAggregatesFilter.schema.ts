...
import { NestedEnumwallet_chainWithAggregatesFilterObjectSchema } from './NestedEnumwallet_chainWithAggregatesFilter.schema';
import { NestedIntFilterObjectSchema } from './NestedIntFilter.schema';
import { NestedEnumwallet_chainFilterObjectSchema } from './NestedEnumwallet_chainFilter.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.Enumwallet_chainWithAggregatesFilter> = z
  .object({
...
export const Enumwallet_chainWithAggregatesFilterObjectSchema = Schema;
