...
const Schema: z.ZodType<Prisma.grantsUpdateManyWithoutBlocks_grants_blocknumberToblocksNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const grantsUpdateManyWithoutBlocks_grants_blocknumberToblocksNestedInputObjectSchema =
  Schema;
