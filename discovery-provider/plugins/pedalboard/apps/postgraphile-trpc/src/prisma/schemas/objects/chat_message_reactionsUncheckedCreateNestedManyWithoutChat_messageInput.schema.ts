...
const Schema: z.ZodType<Prisma.chat_message_reactionsUncheckedCreateNestedManyWithoutChat_messageInput> =
  z
    .object({
      create: z
        .union([
...
export const chat_message_reactionsUncheckedCreateNestedManyWithoutChat_messageInputObjectSchema =
  Schema;
