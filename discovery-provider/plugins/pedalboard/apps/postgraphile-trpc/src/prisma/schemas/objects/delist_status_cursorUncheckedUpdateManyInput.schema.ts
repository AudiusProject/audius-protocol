...
const Schema: z.ZodType<Prisma.delist_status_cursorUncheckedUpdateManyInput> = z
  .object({
    host: z
      .union([
        z.string(),
...
export const delist_status_cursorUncheckedUpdateManyInputObjectSchema = Schema;
