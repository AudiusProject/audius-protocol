...
const Schema: z.ZodType<Prisma.associated_walletsCountOrderByAggregateInput> = z
  .object({
...
export const associated_walletsCountOrderByAggregateInputObjectSchema = Schema;
