...
const Schema: z.ZodType<Prisma.grantsUncheckedCreateNestedManyWithoutBlocks_grants_blocknumberToblocksInput> =
  z
    .object({
      create: z
        .union([
...
export const grantsUncheckedCreateNestedManyWithoutBlocks_grants_blocknumberToblocksInputObjectSchema =
  Schema;
