...
const Schema: z.ZodType<Prisma.blocksUpdateWithoutGrants_grants_blockhashToblocksInput> =
  z
    .object({
      blockhash: z
        .union([
...
export const blocksUpdateWithoutGrants_grants_blockhashToblocksInputObjectSchema =
  Schema;
