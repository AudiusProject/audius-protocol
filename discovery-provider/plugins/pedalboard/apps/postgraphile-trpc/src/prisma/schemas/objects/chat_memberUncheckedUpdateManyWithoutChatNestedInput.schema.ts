...
const Schema: z.ZodType<Prisma.chat_memberUncheckedUpdateManyWithoutChatNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const chat_memberUncheckedUpdateManyWithoutChatNestedInputObjectSchema =
  Schema;
