...
const Schema: z.ZodType<Prisma.grantsUncheckedCreateNestedManyWithoutBlocks_grants_blockhashToblocksInput> =
  z
    .object({
      create: z
        .union([
...
export const grantsUncheckedCreateNestedManyWithoutBlocks_grants_blockhashToblocksInputObjectSchema =
  Schema;
