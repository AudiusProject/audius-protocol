...
const Schema: z.ZodType<Prisma.user_delist_statusesUpdateManyMutationInput> = z
  .object({
    created_at: z
      .union([
        z.coerce.date(),
...
export const user_delist_statusesUpdateManyMutationInputObjectSchema = Schema;
