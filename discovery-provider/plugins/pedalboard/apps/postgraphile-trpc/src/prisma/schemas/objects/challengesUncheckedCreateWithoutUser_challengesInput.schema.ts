...
const Schema: z.ZodType<Prisma.challengesUncheckedCreateWithoutUser_challengesInput> =
  z
    .object({
      id: z.string(),
...
export const challengesUncheckedCreateWithoutUser_challengesInputObjectSchema =
  Schema;
