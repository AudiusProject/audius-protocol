...
const Schema: z.ZodType<Prisma.audio_transactions_historyCountOrderByAggregateInput> =
  z
    .object({
...
export const audio_transactions_historyCountOrderByAggregateInputObjectSchema =
  Schema;
