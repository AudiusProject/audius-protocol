...
const Schema: z.ZodType<Prisma.challenge_profile_completionMinOrderByAggregateInput> =
  z
    .object({
...
export const challenge_profile_completionMinOrderByAggregateInputObjectSchema =
  Schema;
