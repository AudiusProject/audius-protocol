...
const Schema: z.ZodType<Prisma.developer_appsUpdateManyWithoutBlocks_developer_apps_blockhashToblocksNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const developer_appsUpdateManyWithoutBlocks_developer_apps_blockhashToblocksNestedInputObjectSchema =
  Schema;
