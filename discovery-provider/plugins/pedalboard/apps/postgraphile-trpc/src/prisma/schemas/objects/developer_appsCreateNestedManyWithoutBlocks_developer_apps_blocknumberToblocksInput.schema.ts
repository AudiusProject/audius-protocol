...
const Schema: z.ZodType<Prisma.developer_appsCreateNestedManyWithoutBlocks_developer_apps_blocknumberToblocksInput> =
  z
    .object({
      create: z
        .union([
...
export const developer_appsCreateNestedManyWithoutBlocks_developer_apps_blocknumberToblocksInputObjectSchema =
  Schema;
