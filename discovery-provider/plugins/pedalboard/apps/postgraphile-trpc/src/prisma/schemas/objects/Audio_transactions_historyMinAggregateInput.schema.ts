...
const Schema: z.ZodType<Prisma.Audio_transactions_historyMinAggregateInputType> =
  z
    .object({
...
export const Audio_transactions_historyMinAggregateInputObjectSchema = Schema;
