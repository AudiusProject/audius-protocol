...
const Schema: z.ZodType<Prisma.challengesUncheckedUpdateWithoutUser_challengesInput> =
  z
    .object({
      id: z
        .union([
...
export const challengesUncheckedUpdateWithoutUser_challengesInputObjectSchema =
  Schema;
