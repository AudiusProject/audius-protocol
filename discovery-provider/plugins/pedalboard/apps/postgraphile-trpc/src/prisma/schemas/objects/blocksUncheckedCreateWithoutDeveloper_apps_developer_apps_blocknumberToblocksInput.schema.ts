...
const Schema: z.ZodType<Prisma.blocksUncheckedCreateWithoutDeveloper_apps_developer_apps_blocknumberToblocksInput> =
  z
    .object({
      blockhash: z.string(),
...
export const blocksUncheckedCreateWithoutDeveloper_apps_developer_apps_blocknumberToblocksInputObjectSchema =
  Schema;
