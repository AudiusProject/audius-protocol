...
const Schema: z.ZodType<Prisma.chat_messageUpdateManyWithoutChat_memberNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const chat_messageUpdateManyWithoutChat_memberNestedInputObjectSchema =
  Schema;
