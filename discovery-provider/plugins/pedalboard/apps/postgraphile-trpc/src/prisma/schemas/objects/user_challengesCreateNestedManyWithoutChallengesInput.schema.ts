...
const Schema: z.ZodType<Prisma.user_challengesCreateNestedManyWithoutChallengesInput> =
  z
    .object({
      create: z
        .union([
...
export const user_challengesCreateNestedManyWithoutChallengesInputObjectSchema =
  Schema;
