...
def test_get_prev_track_entries(app):
    ...
    test_entities = {
        "tracks": [
            { "track_id": 1, "is_current": False, "is_unlisted": True, "remix_of": None }, # Block 0
            { "track_id": 2, "is_current": True, "is_unlisted": False, "remix_of": None }, # Block 1
            { "track_id": 3, "is_current": False, "is_unlisted": False, "remix_of": None }, # Block 2
            { "track_id": 4, "is_current": False, "is_unlisted": False, "remix_of": None }, # Block 3
            { "track_id": 5, "is_current": False, "is_unlisted": False, "remix_of": None }, # Block 4
            { "track_id": 6, "is_current": False, "is_unlisted": True, "remix_of": None }, # Block 5
            { "track_id": 1, "is_current": True, "is_unlisted": False, "remix_of": None }, # Block 6
            { "track_id": 3, "is_current": False, "is_unlisted": False, "remix_of": None }, # Block 7
            { "track_id": 6, "is_current": True, "is_unlisted": False, "remix_of": None }, # Block 8
            { "track_id": 4, "is_current": True, "is_unlisted": False, "remix_of": None }, # Block 9
            { "track_id": 3, "is_current": True, "is_unlisted": False, "remix_of": None }, # Block 10
            { "track_id": 5, "is_current": False, "is_unlisted": False, "remix_of": None }, # Block 11
            { "track_id": 5, "is_current": True, "is_unlisted": False, "remix_of": None }, # Block 12
        ],
    }
