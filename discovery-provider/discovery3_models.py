...
class Track(Base):
    ...
    __table_args__ = (
        Index('fix_tracks_top_genre_users_idx', 'is_current', 'track_id', 'owner_id', 'genre', 'is_unlisted', 'is_delete'),
        Index('fix_tracks_status_flags_idx', 'is_current', 'track_id', 'is_unlisted', 'is_delete')
    )
...
class User(Base):
    __tablename__ = 'users'
    __table_args__ = (
        Index('fix_users_creator_idx', 'is_current', 'user_id', 'is_creator', 'is_deactivated'),
    )
