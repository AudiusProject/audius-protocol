...
tx_high = None #'3Hcz3K6QnKBiN5vzHkm5pFs3TwoU39St42ZC3rrio4fiu1oknPjRKVp4cXqCE5e9LE6NaP1FA144znHnM4yPtYaU'
...
waudio_token = Token(conn=solana_client, pubkey=token_mint_key, program_id=token_program_key, payer=funder_account)
print(waudio_token)

# Querying this balance:
# https://explorer.solana.com/address/Huc3gaSwGQ74nyjHoKYnJwNijcobecQq4KiuL1tdgtNZ

bal_obj = waudio_token.get_balance(PublicKey('Huc3gaSwGQ74nyjHoKYnJwNijcobecQq4KiuL1tdgtNZ'))
print(waudio_token.get_balance(PublicKey('Huc3gaSwGQ74nyjHoKYnJwNijcobecQq4KiuL1tdgtNZ')))
...
bal_obj_2 = waudio_token.get_balance(PublicKey('E3Q1yeMU3LndGmcPD9msjzbBZEyb8JGtw7CBEwKcGL5g'))
print(bal_obj_2)
'''