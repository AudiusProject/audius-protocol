...
Wallet Connect. Registing nodes with a multisig wallet can now follow the
[Registration][register-a-node] guide

This page is saved for reference and additional information.
...
| `Enter ABI`                | The ABI it detects will be incorrect and must be copied from the code block at the [bottom of this page](#audius-token-abi), or directly from source on [GitHub][token-github] |
...
| Field                            | input                                                                                                                                                                               |
| -------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Address or ENS Name`            | The [Audius Service Registration address `0xD17A9bc90c582249e211a4f4b16721e7f65156c8`][service-reg-address]:https://etherscan.io/address/0xD17A9bc90c582249e211a4f4b16721e7f65156c8 |
