...
[this section](/token/running-a-node/setup/advanced#external-discovery-provider-postgres-instance)
...
[Advanced Setup Guide](/token/running-a-node/setup/advanced)
