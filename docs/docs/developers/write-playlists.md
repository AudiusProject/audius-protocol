...
| `trackMetadatas` | [`UploadTrackMetadata`](/developers/UploadTrackMetadata)`[]`                                                                                                                             | `[]`          | No        | See [here](/developers/sdk/interfaces/UploadTrackMetadata) for full `UploadTrackMetadata` interface. Mood, genre, and tags are inherited from the playlist if not given. |
| `userId`         | `string`                                                                                                                                                                                 | N/A           | Yes       |                                                                                                                                                                          |
