...
| `trackMetadatas` | `TrackMetadata`                                                                                                                                                                          | `[]`          | No        | See [here](/developers/sdk/interfaces/TrackMetadata) for full interface. Mood, genre, and tags are inherited from the playlist if not given. |
| `userId`         | `string`                                                                                                                                                                                 | N/A           | Yes       |                                                                                                                                              |
