...
The following deal type structures are recommended for distribution to Audius. For complete
...
If the following deal structures are provided without pricing information, the following defaults
are assumed
...
:::note Please note, advertisement and subscription model types are not supported. :::
...
Provide fans a previewed stream with a paid option to unlock. After purchasing, full-length
...
preview, see [Metadata](/distributors/specification/metadata) for further reading.
