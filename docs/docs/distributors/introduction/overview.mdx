...
All of the DDEX ingerstion code is open source and available on
[GitHub](https://github.com/AudiusProject/audius-protocol/tree/main/packages/ddex)

You may clone and self-operate your own Audius compatible DDEX ingestion, which provides a web interface to manage uploads